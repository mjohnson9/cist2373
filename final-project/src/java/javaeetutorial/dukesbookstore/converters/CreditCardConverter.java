...
/**
 * The CreditCardConverter class accepts a credit card number of type String and strips blanks and
 * <code>"-"</code>, if any, from it. It also formats the credit card number so that a blank space
 * separates every four characters. Blanks and <code>"-"</code> characters are the expected
 * delimiters that could be used as part of a CreditCardNumber.
 */
@FacesConverter("ccno")
public class CreditCardConverter implements Converter {
  ...
  /** Parses the CreditCardNumber and strips any blanks or <code>"-"</code> characters from it. */
  @Override
